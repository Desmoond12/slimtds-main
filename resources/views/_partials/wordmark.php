<?php
/**
 * Composite brand mark: chip + AffMoment/TDS wordmark.
 *
...
<span style="display:inline-flex;align-items:center;gap:10px;text-decoration:none">
    ...
    <span style="display:inline-flex;flex-direction:column;line-height:1">
        <span style="font-family:var(--font-display);font-size:<?= e($textSize) ?>;font-weight:600;color:<?= e($text) ?>;letter-spacing:-0.02em">AffMoment<span style="color:<?= e($accent) ?>">/</span>TDS</span>
        <?php if ($tagline): ?>
