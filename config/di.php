...
return static function (): \DI\Container {
    ...
    $builder->addDefinitions([
        ...
        \App\Shared\RateLimit\PublicRateLimitMiddleware::class => \DI\autowire(),
        ...
        \App\Shared\Session\PgSessionHandler::class => static function (\App\Shared\Db\Connection $db): \App\Shared\Session\PgSessionHandler {
            ...
            $absoluteLifetime = (int)($_ENV['SESSION_ABSOLUTE_LIFETIME'] ?? 2_592_000);
            return new \App\Shared\Session\PgSessionHandler($db, $lifetime, $absoluteLifetime);
        },
        ...
        \App\Admin\Repository\AffiliateNetworkRepository::class => \DI\autowire(),
        \App\Admin\Form\AffiliateNetworkForm::class => \DI\autowire(),
        ...
        \App\Admin\Repository\PostbackRequestRepository::class => \DI\autowire(),
        \App\Admin\Controller\PostbackLogController::class => \DI\autowire(),
