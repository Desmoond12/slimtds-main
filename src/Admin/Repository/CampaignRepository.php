...
final class CampaignRepository
{
    ...
    public function create(array $data): Campaign
    {
        ...
        $row = $this->db->fetchOne(
            <<<'SQL'
                INSERT INTO core.campaigns (slug, name, notes, is_active, trash_mode, trash_url, sticky_offer, network_id)
                VALUES (:slug, :name, :notes, :is_active, :trash_mode, :trash_url, :sticky_offer, :network_id)
                RETURNING *
            SQL,
            [
                'slug'         => $slug,
